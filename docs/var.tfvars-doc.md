...
Change the image names according to your environment. Ensure that you use RHCOS 4.5.x image only with this automation code.
```
...
Change the URL to the specific version of OCP 4.5.x release that you want to install on PowerVS.
...
openshift_client_tarball    = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/clients/ocp/stable-4.5/openshift-client-linux.tar.gz"
```
