...
Change the image names according to your environment. Ensure that you use RHCOS 4.7.x image only with this automation code.
...
Change the URL to the specific 4.7.x version that you want to install on PowerVS.
