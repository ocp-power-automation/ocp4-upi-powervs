...
This branch must be used with OCP 4.11.x versions only.
...
Ensure you checkout the correct `release-VERSION` branch depending on the version (4.10, 4.11 ...) of RedHat OpenShift you want to install:

For example to use OCP 4.11 perform the following
```
export VERSION=4.11
