...
locals {
  ...
  is_per                  = contains(["che02", "che03", "dal10", "dal12", "dal13", "dal14", "fra04", "fra05", "lon04", "lon06", "mad02", "mad04", "osa21", "sao01", "sao04", "syd04", "syd05", "tok04", "tor01", "us-east", "wdc04", "wdc06", "wdc07"], var.ibmcloud_zone)
