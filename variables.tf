...
variable "helpernode_tag" {
    ...
    default = "4f6745c7943613c17745d6c37b0c537657eba203"
}
...
variable "install_playbook_tag" {
    ...
    default = "5d837d83d52fd16da44447dde572c35ec783b30a"
}
...
variable "openshift_install_tarball" {
    default = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/clients/ocp/stable-4.5/openshift-install-linux.tar.gz"
}

variable "openshift_client_tarball" {
    default = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/clients/ocp/stable-4.5/openshift-client-linux.tar.gz"
}
